...
export const CHANGELOG: ChangeEntry[] = [
  {
    ...
    title: '游戏进了小红书小工具',
    changes: [
      { kind: '新增', text: '整个游戏（VCT电竞经理 + 开瓦包）打包成了小红书小工具，可以直接在小红书里离线打开，不用浏览器也不用联网。内容和网页版完全一样。' },
      { kind: '调整', text: '小工具版本是离线运行的：进度、收藏、段位和签到全部存在你自己的设备上，不会上传，也不会跟着 ID 换设备走。签到日期按本机时间的北京时区算。网页版不受影响，照旧云端同步。' },
      { kind: '调整', text: '小工具里不能导出/导入存档文件（容器不允许），存档改为只保存在设备内；也不能点开外部链接，爱发电地址和 vlr.gg / Liquipedia 出处改为直接显示文字。' },
    ],
  },
  {
    date: '2026-08-30',
