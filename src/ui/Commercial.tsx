...
import {
  bookGig, cancelGig, declineSponsor, endStream, freeDays, openGigs, pitchSponsor, SPONSOR_MAX,
        ...
        <div className="row wrap" style={{ gap: 10, alignItems: 'center', marginBottom: 14 }}>
          ...
          <span className="tiny faint">
            {game.pitchCooldown != null && game.pitchCooldown > game.day
              ...
              : `免费，每 10 天一轮，最多同时持有 ${SPONSOR_MAX} 家（现有 ${game.teams[game.myTeam]?.sponsors.length ?? 0} 家）。3 天后对方给出具体条件，你再决定签不签`}
          </span>
        </div>
