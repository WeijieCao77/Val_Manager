    ...
    <>
      ...
      <Panel title={`更衣室 · 全队默契 ${harmony >= 0 ? '+' : ''}${harmony.toFixed(0)}`} flush>
        <p className="small muted" style={{ padding: '10px 14px 0', margin: 0 }}>
          每两名选手之间有独立的关系值。<b>开局就不一样</b>，最重的一条是
          <b>一起打了多久</b>（取自 Liquipedia 的真实转会履历）：一年 +15、两年 +21、四年 +29。
          其次是同国籍、位置上要天天配合（决斗↔先锋、控场↔哨卫）、年纪相仿、本身协同沟通就好。
          所以多年老班底 + 全华班的更衣室，会明显比刚拼起来的混编阵容紧密。之后：<b>赢球让所有人更亲近</b>；输球时，如果一个人打得
