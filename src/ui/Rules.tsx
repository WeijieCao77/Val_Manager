...
const SECTIONS: Section[] = [
  ...
  },
  {
    key: 'loyal',
    title: '忠诚度',
    lede: '这一项在整局游戏里不会变。真实选手的忠诚来自原始数据，新人开局随机 40~75，'
      + '之后无论你怎么带他都是那个数。想让人留下要看的是信任和不满，不是这个。',
    use: [
      '谈合同时方向相反：续约时 (忠诚 − 50) × 0.35 是加分，别的队来挖他时同样的数变成阻力。',
      '你去问价别队球员时，他的态度里还要再扣一次 (忠诚 − 50) × 0.5——这一项比合同分量更重。',
      '所以高忠诚的人「自己队留得住，别人挖不走」，低忠诚的人两头都松。',
      '想撬别队的核心，先看他的忠诚——忠诚 75 的人光靠加钱很难谈。',
    ],
  },
  {
    key: 'grief',
