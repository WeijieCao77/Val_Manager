...
export const TOUR: TourStep[] = [
  ...
  },
  {
    target: 'dashboard',
    title: '总览 · 每天从这里开始',
    body: '最上面是今天的待办，下面是那条红色的「推进」大按钮——这是推动游戏往前走的地方，看完待办就按它。空档期时它会变成「推进 7 天」，一回合直接跳过一周，行动力还是 3 点；临近比赛会自动变回一天一回合。再往下是下一场比赛、今天做过什么、五名首发谁出了问题。',
  },
  {
    target: 'squad',
    title: '阵容 · 你的人',
  ...
  },
  {
    target: null,
    title: '最后一件事：行动力',
    body: '右上角的 ⚡ 是本回合的行动力。赛季中一天一回合、2 点；空档期一周一回合、6 点——转会窗开着的时候正是要做事的时候。报价、问价、商务、约战、聘教练、挂牌解约这些对外事务各花 1 点；调首发、改战术、安排训练不花点数。用完了就按总览上那个红色的「推进」按钮进入下一回合。',
  },
]
